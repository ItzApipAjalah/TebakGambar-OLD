...
public class level11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linearLayout = findViewById(R.id.bgl11);
        ...
        CountDownTimer timer = new CountDownTimer(40000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intentLoadNewActivity = new Intent(level11.this, level10.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mp.start();
                timer.cancel();
                Intent intentLoadNewActivity = new Intent(level11.this, MainActivity.class);
                intentLoadNewActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        ...
        imagebtn = (ImageButton) findViewById(R.id.bantuan11);
        ...
        imagebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mp.seekTo(0);
                mp.start();
                mDialog.setContentView(R.layout.hint11);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(editText.getText().toString().equalsIgnoreCase("aceh"))
                {
                    correct.seekTo(0);
                    correct.start();
                    Dialog dialog = new Dialog(context);
                    dialog.setContentView(R.layout.betul11);
                    ...
                    dialogButton1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intentLoadNewActivity = new Intent(level11.this, level12.class);
                            startActivity(intentLoadNewActivity);
                            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        }
                    });
