...
public class level17 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout linearLayout = findViewById(R.id.bgl17);
        ...
        CountDownTimer timer = new CountDownTimer(40000, 1000) {
            ...
            public void onFinish() {
                ...
                Intent intentLoadNewActivity = new Intent(level17.this, level16.class);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mp.start();
                timer.cancel();
                Intent intentLoadNewActivity = new Intent(level17.this, MainActivity.class);
                intentLoadNewActivity.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                MyMediaPlayer.getMediaPlayerInstance().stopAudioFile();
                startActivity(intentLoadNewActivity);
        ...
        imagebtn = (ImageButton) findViewById(R.id.bantuan17);
        ...
        imagebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mp.seekTo(0);
                mp.start();
                mDialog.setContentView(R.layout.hint17);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(editText.getText().toString().equalsIgnoreCase("kelautan"))
                {
                    correct.seekTo(0);
                    correct.start();
                    Dialog dialog = new Dialog(context);
                    dialog.setContentView(R.layout.betul17);
                    ...
                    dialogButton1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent intentLoadNewActivity = new Intent(level17.this, level18.class);
                            startActivity(intentLoadNewActivity);
                            overridePendingTransition(R.anim.slide_in_right, R.anim.slide_out_left);
                        }
                    });
